...
export default class SecondPanel extends RX.Component<SecondPanelProps, SecondPanelState> {
        ...
        return (
            <RX.ScrollView style={styles.scroll}>
                <RX.View style={styles.container}>
                    <RX.Button style={styles.button} onPress={this._onPressBack}>
                        <RX.Text style={styles.buttonLabel}>
                            Go Back
                        </RX.Text>
                    </RX.Button>
